...
- `set` → the whole set, including the tools discovery lists only as whole-vendor options (orchestrators, phases,
...
Change nothing. This command answers "what have I got", not "do something" — that is
`/design-tools:discover <task>`.
